  ...
  return (
    <section className="container mx-auto py-12 max-w-3xl">
      ...
      <p className="text-foreground/70 mb-8">
        Sharpen quantitative, logical, and verbal skills with timed quizzes and
        explanations.
      </p>
      ...
      <div className="rounded-lg border bg-card">
        ...
        <div className="p-4 space-y-4">
          ...
          {picked !== null && (
            <div
              className={`text-sm rounded-md border p-3 ${correct ? "border-green-500/30 bg-green-500/10 text-green-700" : "border-red-500/30 bg-red-500/10 text-red-700"}`}
            >
